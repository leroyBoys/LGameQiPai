...
/**
 */
public enum MjCmd implements ModuleCmd {
    ...
    Game(1,true,HttpRequestType.tcp),
    /**
     * 结算
     */
    Result(2,true,HttpRequestType.tcp),
    /**
     * pao
     */
    YaPao(3,true,HttpRequestType.tcp),
    ;
    ...
    MjCmd(int value, boolean isRequireOnline, HttpRequestType requetType) {
        this.value = value;
