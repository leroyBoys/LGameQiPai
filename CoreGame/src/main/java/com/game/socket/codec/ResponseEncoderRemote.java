...
public class ResponseEncoderRemote extends ResponseEncoder {
    ...
    public static byte[] getCommondMes(Response response, int uid,String key, IoSession session) throws Exception {
        ...
        if(datas == null && obj != null){
            ...
            SystemLogger.info(ResponseEncoderRemote.class,"uid:"+uid+"---Send--cmd:"+ CMDManager.getCmd(com.getCmd())+"  module:"+CMDManager.getModule(com.getCmd())+"  "+obj.toString());
        }else {
            SystemLogger.info(ResponseEncoderRemote.class,"uid:"+uid+"---Send---cmd:"+ CMDManager.getCmd(com.getCmd())+"  module:"+CMDManager.getModule(com.getCmd())+com.build().toString());
        }
